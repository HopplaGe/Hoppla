    ...
    <>
      ...
      >
        <div
          ...
          onClick={() => handleOpen(startLatLng)}
          className="group min-h-10 hover:bg-default-100 hover:rounded-t-xl transform transition-all duration-300 ease-in-out pt-2 cursor-pointer"
        >
            ...
            <div className="flex justify-between">
              ...
              <div className="relative flex-1 py-2 pr-4 flex flex-col gap-2">
                ...
                <div className="flex gap-2 justify-start items-center">
                  ...
                  >
                    {t("distanceFromDeparture", {
                      distance: meterToKm(fromDistance),
                    })}
                  </span>
                </div>
                <div className="absolute top-1/2 right-0 -translate-y-1/2 group-hover:text-primary">
                  <ChevronRight />
                </div>
              </div>
            </div>
        ...
        <div
          ...
          onClick={() => handleOpen(endLatLng)}
          className="group min-h-10 hover:bg-default-100 hover:rounded-none transform transition-all duration-300 ease-in-out cursor-pointer"
        >
          <div className="flex flex-col px-6">
            <div className="flex justify-between">
              <div className="flex flex-col pt-1">
        ...
        <div className="flex flex-row justify-between items-center border-t-4 p-4 fira-go border-default-50 w-full">
          <div className="flex flex-col gap-2">
            {t("priceForOnePerson", {
              count: searchParams.requested_seats
                ? searchParams.requested_seats
                : 1,
            })}
          </div>
