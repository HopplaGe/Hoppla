...
export default function UsersTable() {
    ...
    // console.log(isUserLoading, isUserError, user);
    ...
    const [rowsPerPage, setRowsPerPage] = React.useState(TAKE_USERS);
    ...
    const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
        ...
        switch (columnKey) {
            ...
            case "age":
                return <span>{moment().diff(user.birthdate, "years")}</span>;
            case "status":
                return (
                    <Chip
                    ...
                    <div className="flex gap-3">
                        <Dropdown>
                            <DropdownTrigger className="hidden sm:flex">
                                <Button
                                    endContent={"<ChevronDownIcon className=/>"}
                                    variant="flat"
                                >
                                    Status
                                </Button>
