...
export default function Ride({ ride }: RideProps) {
    ...
    console.log(locale)
    return <div className="bg-white p-5 rounded-xl px-4 py-4 w-full ">
        <div className="flex justify-between">
            ...
            <div>{
                ...
                ) : ride.status === "COMPLETED" ? "დასრულებული" : "გაუქმებული"
            }</div>
        </div>
        ...
        <div className="grid grid-cols-4">
            ...
            <div>
                <h3 className="text-primary">{secondsToHours(ride.duration)} სთ</h3>
                <p className="text-gray-700 text-sm">დრო</p>
            </div>
            <div>
                <h3 className="text-primary">{meterToKm(ride.distance)} კმ</h3>
