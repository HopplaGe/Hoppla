...
const navigation = {
    blog: [
        ...
        {
            name: "The Benefits of Carpooling: Saving Money and the Environment",
            href: "#",
        },
        {name: "Top Travel Destinations Best Reached by Carpooling", href: "#"},
        {
            name: "How to Find the Perfect Carpool Match for Your Commute",
            href: "#",
        },
        {
            name: "Exploring New Places: The Ultimate Guide to Group Travel by Carpool",
            href: "#",
        },
    ],
    legal: [
            ...
            <div className="page-wrapper pt-16">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    <div className="space-y-8">
                        ...
                        <div
                            className="flex flex-col md:flex-row gap-4 justify-center items-center md:justify-start">
                            <LanguageSwitch/>
                            <LocationSwitch/>
                        </div>
                    </div>
