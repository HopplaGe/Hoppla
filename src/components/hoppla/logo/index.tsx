...
>(({ variant, color, size, className, animation, ...props }, ref) => {
  const darkColor = logoStyle({ color }).substring(
    logoStyle({ color }).indexOf(" ") + 14,
  );
  const lightColor = logoStyle({ color }).substring(
    logoStyle({ color }).indexOf(" ") + 1,
    logoStyle({ color }).indexOf(" ") + 13,
  );
  ...
  return (
    <motion.svg
      ...
      x="0px"
      y="0px"
      viewBox={size === "lg" ? "0 0 756 274.6" : "0 0 257.57 191.63"}
      className={cn(
      ...
      <g id="Layer_2-2">
        {size === "lg" ? (
          <g>
            <>
              <path
                className={cn("st0", logoStyle({ variant }))}
                d="M135.5,120.8c0,33.2,0,66.4,0,99.7c0,1.6-0.5,2.8-2,3.6c-0.5,0.2-1,0.3-1.6,0.3c-7.2,0-14.4,0.1-21.6,0
			...
			c0.9,0,1.7,0.1,2.4,0.6c0.9,0.6,1.4,1.4,1.4,2.6c0,0.3,0,0.7,0,1C135.5,54.4,135.5,87.6,135.5,120.8L135.5,120.8z"
              ...
              <path
                className={cn("st0", logoStyle({ variant }))}
                d="M737.3,224.2c-5.6,0-11.2-0.1-16.8,0c-1.6,0-2.7-0.5-3.5-1.9c-0.8-1.4-2.1-2.3-3.2-3.4
			...
			C670.4,128,658.7,139.5,658.9,153.5L658.9,153.5z"
              ...
              <path
                className={cn("st0", logoStyle({ variant }))}
                d="M214.7,224.2c-40-0.4-70.6-32.6-70.1-71c0.5-39.3,32.4-69.9,71.1-69.3c39.3,0.6,69.6,32.3,69.3,70.6
			...
			c-0.5-11.3-10.1-25.9-28.9-25C200.2,127.9,187.7,139.1,188.1,154L188.1,154z"
              ...
              <path
                className={cn("st0", logoStyle({ variant }))}
                d="M605.1,116.5c0,34.6,0,69.1,0,103.7c0,0.7,0.1,1.5-0.2,2.1c-0.8,1.4-1.9,2-3.5,2c-6.7,0-13.5,0-20.2,0
            ...
            <path
              className={cn("st0", lightColor)}
              d="M294.8,274.5c0-1.8,0-3.6,0-5.4c0-4.4,0.1-8.9,0.1-13.3c0-14.6,0-29.2,0-43.8c0-7.2,0-14.4,0-21.6
