        ...
        <div role="list"
            ...
            {cars.length > 0 ? cars.map((car, index) => (
                    <Popover key={index} showArrow placement="bottom">
                        ...
                        <PopoverTrigger className="cursor-pointer bg-white p-4 shadow-lg">
                ...
                <div
                    className={cn(`text-center text-gray-500 ${cars.length === 0 && "col-span-3"} text-left fira-go`)}>{t('NoVehicles')}</div>}
        </div>
    );
};
