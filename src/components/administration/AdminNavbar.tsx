...
const AdminNavbar = () => {
    ...
    return (
        <>
            <div
                className="sticky top-0 z-40 flex w-full h-16 shrink-0 justify-between items-center gap-x-4 border-b border-gray-200 bg-white px-4 sm:gap-x-6 sm:px-6 lg:px-8">
