    ...
    return (
        <>
            <div className='relative group'>
                    ...
                    <Link href="#" className="flex flex-col px-6">
                        <div className="flex justify-between">
                            <div className="flex flex-col pt-1">
                                ...
                                <span className="text-gray-500 text-xs font-semibold">{secondsToHours(rideData.duration!)}</span>
                            </div>
                ...
                <div className="absolute top-1/2 right-4 -translate-y-1/2 bg-default-100 fira-go text-xl font-semibold text-default-600 group-hover:bg-primary group-hover:text-white px-4 py-2 rounded-xl">
                    {rideData.price} ₾
                </div>
            </div>
