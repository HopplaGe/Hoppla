...
const RideCard = ({
  ...
  const arrivalTime = moment(rideData.startTime, "HH:mm")
    .add(secondsToHours(rideData.duration!), "seconds")
    .format("HH:mm");
  ...
  return (
    ...
    >
      <div className="relative group">
            ...
            <div className="flex justify-between">
              <div className="flex flex-col pt-1">
                ...
                <span className="text-gray-500 text-xs font-semibold">
                  {secondsToHours(rideData.duration!)}
                </span>
              </div>
              ...
              <div className="relative flex-1 py-2 pr-4 flex flex-col gap-2">
                ...
                <div className="flex gap-2 justify-start items-center">
                  ...
                  >
                    {meterToKm(fromDistance)} კმ გასვლის ადგილამდე
                  </span>
                </div>
              ...
              <div className="relative flex-1 py-2 pr-4 flex flex-col gap-2">
                ...
                <div className="flex gap-2 justify-start items-center">
                  ...
                  <span
                    ...
                    aria-label="Distance from departure location"
                  >
                    {meterToKm(toDistance)} კმ თქვენს დანიშნულებამდე
                  </span>
                </div>
                {/* <div className="absolute top-1/2 right-0 -translate-y-1/2 group-hover:text-red-600">
                                    <ChevronRight />
        ...
        <div className="absolute top-1/2 right-4 -translate-y-1/2 bg-default-100 fira-go text-sm lg:text-medium font-semibold text-default-600 hoppla-animation group-hover:bg-primary group-hover:text-white px-4 py-2 rounded-xl">
      ...
      <div className="flex justify-between px-6 py-2 border-t border-default-100">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs fira-go">
                <span className="text-gray-500">
                  {rideData?.driver?.ratings?.length > 0
                    ? rideData?.driver?.ratings?.reduce(
                        (acc: number, rating: any) => acc + rating.rating,
                        0,
                      ) / rideData?.driver?.ratings?.length
                    : 0}
                </span>
        ...
        <div className="">
          ...
          <div className="flex flex-row text-sm fira-go">
            <AvatarGroup>
              {rideData.trip?.passangers &&
                rideData?.trip?.passangers?.map(
